...
public class Client {
    ...
    JLabel statusLabel = new JLabel("Status: INIT"); // Statistics
    ...
    // DoneTASK Complete all button handlers
    ...
    class setupButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (state == INIT) {
                ...
                try {
                    // DoneTASK construct a new DatagramSocket to receive server RTP packets on port RTP_RCV_PORT
...
//                     FECsocket = new DatagramSocket(FEC_RCV_PORT);
                ...
                if (parse_server_response() != 200) {
                    ...
                    // DoneTASK change RTSP state and print new state to console and statusLabel
                    state = READY;
    ...
    class playButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (state == READY) {
                // DoneTASK increase RTSP sequence number
                RTSPSeqNb++;
                ...
                if (parse_server_response() != 200) {
                    ...
                    // DoneTASK change RTSP state and print out new state to console an statusLabel
                    state = PLAYING;
    ...
    private void send_RTSP_request(String request_type) {
        ...
        try {
            ...
            // DoneTASK Complete the RTSP request method line
            String rtspReq = request_type + " " + rtsp + " RTSP/1.0" + CRLF;

            // DoneTASK write the CSeq line:
            ...
            if (request_type.equals("SETUP")) {
                // DoneTASK Complete the Transport Attribute
